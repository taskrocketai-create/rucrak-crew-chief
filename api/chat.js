...
1. **Straight-on, from directly behind the vehicle** (spare tire and hitch receiver both visible, taken from a few feet back). This is the shot for **tire width** (measurement #1) — it shows the tire's full tread face next to the hitch opening, which is what you need to judge width against a known scale reference.
