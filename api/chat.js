...
- If it looks close to the line, or the photo angle/distance makes it hard to judge — say exactly that. Do not force a confident-sounding answer out of an ambiguous photo. Recommend the sidewall-reading method below (it beats any photo estimate) or a retake from further back, at the correct angle for that specific measurement.
...
**Straightedge fallback (when the sidewall isn't readable):** rest something rigid and straight (a yardstick, a 2x4, a level) directly across the widest point of the tire tread and measure straight across — the manual equivalent of the sidewall number.
